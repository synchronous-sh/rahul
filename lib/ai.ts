...
export type NewsBrief = { sections: Array<{ heading: string; paragraphs: string[] }> };
...
export const expandNewsArticle = (story: { id: string; title: string; description: string; content?: string; source: string; link: string }) =>
  invokeAI<NewsBrief>('expand-news-article', story);
